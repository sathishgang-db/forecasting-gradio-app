...
df = pd.read_csv("./actuals_and_forecasts_whrl.csv")
...
with gr.Blocks(theme="soft") as demo:
    gr.Markdown(
        """#### LUI for Forecasting \n
         #####  ⚡️⚡️ Powered By Databricks Lakehouse Platform! \n
            This demo shows how to use LUI for Forecasting to ask questions about the data. \n
            Interact with the demo using any of the `examples` below 🚀!"""
    )
    with gr.Row():
        with gr.Column():
            ...
            examples = [
                "What are the actuals for Dryers in Jan 2023?",
                "What are the forecasts for Washers in 2023?",
                "Summarize all the data for Microwaves in 2023",
                "Forecasts for all categories in October 2023",
            ]
